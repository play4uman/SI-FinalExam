...
\textit{\textbf{Алтернативно описание:}}
\textit{\textbf{Източник: }} \path{https://learn.fmi.uni-sofia.bg/pluginfile.php/126968/mod_resource/content/17/lab-6.pdf}\\

\newgeometry{left=0.5in,right=0.8in,top=1in,bottom=1in}
\includegraphics[scale=0.85]{AlternativeFormula.png}\\
\includegraphics[scale=0.85]{AlternativeFormula2.png}\\
